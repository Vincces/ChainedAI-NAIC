...
from my_model_define_tf import get_custom_objects
...
# load model
encoder_address = './Modelsave/encoder_no_change_830.h5'
...
np.save('./Modelsave/encoder_output_830.npy', encode_feature)
