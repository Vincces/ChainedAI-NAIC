...
from my_model_define_tf import NMSE, Score, get_custom_objects
...
# load encoder_output
decode_input = np.load('./Modelsave/encoder_output_830.npy')

# load model and test NMSE
decoder_address = './Modelsave/decoder_change_3_830.h5'
