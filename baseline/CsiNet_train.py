...
def residual_network(x, residual_num, encoded_dim):
    def add_common_layers(y):
        y = BatchNormalization()(y) #BatchNormalization 是标准化层，解决传统的神经网络训练需要我们人为的去选择参数，比如学习率、参数初始化、权重衰减系数、Drop out比例 的问题，并能提高算法的收敛速度。
        y = LeakyReLU()(y) #高级activation function
        return y
    def residual_block_decoded(y):
        ...
        y = Conv2D(2, kernel_size=(3, 3), padding='same', data_format='channels_first')(y) #data_format='channels_last'
