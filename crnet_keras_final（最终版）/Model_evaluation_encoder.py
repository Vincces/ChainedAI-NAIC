...
from Model_define_tf_crnet_mod import get_custom_objects
...
# load model
encoder_address = './Modelsave/encoder_0140.h5'
...
np.save('./Modelsave_914/encoder_output_924.npy', encode_feature)
