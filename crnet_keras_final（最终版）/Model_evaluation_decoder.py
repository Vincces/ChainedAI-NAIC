...
from Model_define_tf_crnet_mod import NMSE, Score, get_custom_objects
...
# load encoder_output
decode_input = np.load('./Modelsave_914/encoder_output_924.npy')

# load model and test NMSE
decoder_address = './Modelsave/decoder_0140.h5'
