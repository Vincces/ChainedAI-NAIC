...
from Model_define_tf_crnet_no_refine import Encoder, Decoder, NMSE
...
autoencoder.compile(optimizer=adam, loss=NMSE_LOSS)
...
# =============================================================================
y_test = autoencoder.predict(x_train, batch_size=512)
print('The test NMSE is ' + np.str(NMSE(x_train, y_test)))
