...
from Model_define_tf_crnet_no_refine import get_custom_objects
...
# load model
encoder_address = './Modelsave/encoder_1.h5'
...
np.save('./Modelsave/encoder_output_911.npy', encode_feature)
